<template>
    <div class="searchscreen-container">
        ...
        <div class="main-content">
            <!-- Top Bar with Search -->
            <div class="top-bar">
                <input type="text" placeholder="Pesquisar novas comunidades..." class="search-bar" />
            </div>
                ...
                <div class="disciplinas-grid">
                    <div v-for="disciplina in disciplinas" :key="disciplina.nome" 
                        ...
                        <div class="card-header">
                            <img src="/images/logic-icon.png" alt="Comunidade" class="community-icon" />
...
export default {
    ...
    data() {
        return {
            disciplinas: [
                { nome: "Lógica de Programação", descricao: "Essa comunidade foca em conceitos básicos e avançados de lógica de programação.", cor: "#d9f8c4" },
                { nome: "Engenharia de Software", descricao: "Aprenda sobre design, arquitetura e ciclo de vida do software.", cor: "#c4f0f8" },
                { nome: "Banco de Dados", descricao: "Explore conceitos de modelagem e gerenciamento de dados.", cor: "#e3d9f8" },
                { nome: "Desenvolvimento Web", descricao: "Aprenda sobre criação de sites e aplicações modernas.", cor: "#f8d9d9" },
                { nome: "Inteligência Artificial", descricao: "Descubra técnicas de machine learning e redes neurais.", cor: "#fff2d4" },
                { nome: "Redes de Computadores", descricao: "Entenda como funcionam as redes e a segurança da informação.", cor: "#f8d4e4" }
            ]
        };
    },
    methods: {
