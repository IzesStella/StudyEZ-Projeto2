  ...
  <div class="community-container">
    ...
    <main class="main-content">
      ...
      <div class="logo-container">
        <img src="/images/community-logo.png" alt="Comunidade" class="community-logo" />
...
<section class="posts">
  <article v-for="post in posts" :key="post.id" class="post">
    <div class="post-header">
      ...
      <div>
        <span class="username">{{ post.username }}</span> <!-- Nome do usuário aqui -->
        <span class="timestamp">• {{ post.timestamp }}</span>
      </div>
    </div>
    <h2 class="post-title">{{ post.title }}</h2> <!-- Título da postagem movido para baixo -->
        ...
        posts: [
          {
            ...
            content: 'Como vocês estudam? Ainda mais uma linguagem diferente? Digo, não só copiar o código, mas realmente aprender sobre?',
            timestamp: 'há 7h',
            comments: 0,
          },
          {
            ...
            content: 'Criamos uma página de HTML para cadastro, mas há um botão que baixa o arquivo ao invés de redirecionar. Como corrigir?',
            timestamp: 'há 1 dia',
            comments: 0,
          },
        ],
